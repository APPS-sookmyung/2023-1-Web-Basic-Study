...
function maxItems(n, arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
      ...
      if (total + itemTotal <= n) { // 예산 안에 있는 경우 구매
        cnt++;
        total += itemTotal;
      }
    }
  ...
  let arr = [[6000, 6000], [2000, 2000], [4000, 3000], [4000, 5000], [10000, 3000]];
  console.log(maxItems(28000, arr));
  


// 90점 이상 학생 이름 출력
const testArray = [{name: "조영서", score: 100}, {name: "신진영", score: 90}, {name: "오지수", score: 80}, {name: "서정연", score: 70}];
